"""
Django settings for cobauas project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-kbb0ly3_frj3(y1-)$e@+k0+3gt2yytxp^ui868z9@m8xevsdw')
...
WSGI_APPLICATION = 'cobauas.wsgi.application'
